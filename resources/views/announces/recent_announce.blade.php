...
@include('layouts.nav-page')
    ...
    <section class='pb-5'>
        <div class='container'>
            ...
            <div class="card-deck">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa fa-folder-open" aria-hidden="true"></i> <a href=""></a></p>

                            <p class="card-text"><i class="fa fa-map-marker" aria-hidden="true"></i> <a href=''> </a></p>

                            <p class="card-text"><i class="fa fa-eye" aria-hidden="true"></i> </p>
                        </div>
                        <div class="card-footer">
                            <small class="text-muted"><i class="fa fa-clock-o" aria-hidden="true"></i> </small>
                        </div>
                    </div>
            ...
            <div class='row mt-5'>
                <div class='mx-auto'>
                    <a href="{{route('announce')}}" class='btn btn-outline-primary px-4 font-weight-bold py-3'>Consultez toutes les annonces</a>
                </div>
            </div>
        </div>
    </section>
